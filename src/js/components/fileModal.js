...
export class FileModal extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.style = `
        background-color: white;position: absolute;width: 900px;height: 600px;left: ${
          700 + this._initOffset
        }px;top: ${
      150 + this._initOffset
    }px;border: solid;padding: 8px;z-index: 1; display
        `;
    this.innerHTML = `
            <style>
                .file-modal-preview{
