...
export function hillClimbing_Fast_NoGrid(graph) {
  ...
  function Norm_M1(m) {
    ...
    if (m1.length == 1 || m1.length == 2) {
      ...
      newSDM1 = SD_measures(m, oldSDM1, oldAvgM1, newAvgM1, m1.length - 1); // find standard deviation
      oldAvgM1 = newAvgM1;
      oldSDM1 = newSDM1;
    }
    maxmin_m1(m);
  ...
  function Norm_M2(m) {
    ...
    if (m2.length == 1 || m2.length == 2) {
      ...
      newSDM2 = SD_measures(m, oldSDM2, oldAvgM2, newAvgM2, m2.length - 1); // find standard deviation
      oldAvgM2 = newAvgM2;
      oldSDM2 = newSDM2;
    }
    maxmin_m2(m);
  ...
  function Norm_M4(m) {
    ...
    if (m4.length == 1 || m4.length == 2) {
      ...
      newSDM4 = SD_measures(m, oldSDM4, oldAvgM4, newAvgM4, m4.length - 1); // find standard deviation
      oldAvgM4 = newAvgM4;
      oldSDM4 = newSDM4;
    }
    maxmin_m4(m);
  ...
  function Norm_M5(m) {
    ...
    if (m5.length == 1 || m5.length == 2) {
      ...
      newSDM5 = SD_measures(m, oldSDM5, oldAvgM5, newAvgM5, m5.length - 1); // find standard deviation
      oldAvgM5 = newAvgM5;
      oldSDM5 = newSDM5;
    }
    maxmin_m5(m);
