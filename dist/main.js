!(function (t) {
  ...
  function (t, e, r) {
    (function (e) {
      ...
      t.exports = {
        mode: "development",
        entry: { layoutWorker: "./src/js/layoutWorker.js" },
        output: { path: n.join(e, "build"), filename: "[name].js" },
  ...
  function (t, e) {
    ...
    function h() {
      f &&
        l &&
        ((f = !1), l.length ? (s = l.concat(s)) : (a = -1), s.length && p());
    }
    function p() {
      if (!f) {
        var t = c(h);
    ...
    (o.nextTick = function (t) {
      ...
      s.push(new v(t, e)), 1 !== s.length || f || c(p);
    }),
